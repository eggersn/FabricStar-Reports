...
# Read csv
hyperledger_path = "Create_Assets_1000/Hyperledger_Evaluation.csv"
fabricstar_path = "Create_Assets_1000/FabricStar_Evaluation.csv"
...
# Input
x_values = [300, 600, 900, 1050, 1200, 1350, 1500, 1650, 1800]
...
ax2.bar(np.array(x_values)-25, y_error1_hyperledger, width=50, color="lightsteelblue", align="center", alpha=0.8, zorder=1)
hyperledger_label_bar = ax2.bar(np.array(x_values)-25, y_values_hyperledger, width=50, color="blue", align="center", alpha=0.8, zorder=1)
ax2.bar(np.array(x_values)-25, y_error2_hyperledger, width=50, color="darkblue", align="center", alpha=0.8, zorder=1)
...
ax1.plot(x_values, y_values_fabricstar, color="green", zorder=5, linewidth=3)
...
fabricstar_label, = ax1.plot(x_values, y_values_fabricstar, 'D', color="green", zorder=5)
ax1.fill_between(x_values, y_error1_fabricstar, y_error2_fabricstar, color="lightgreen", zorder=5, alpha=0.5)
...
ax2.bar(np.array(x_values)+25, y_error1_fabricstar, width=50, color="navajowhite", align="center", alpha=0.8, zorder=1)
fabricstar_label_bar = ax2.bar(np.array(x_values)+25, y_values_fabricstar, width=50, color="goldenrod", align="center", alpha=0.8, zorder=1)
ax2.bar(np.array(x_values)+25, y_error2_fabricstar, width=50, color="darkgoldenrod", align="center", alpha=0.8, zorder=1)


plt.legend([hyperledger_label, hyperledger_label_bar, fabricstar_label, fabricstar_label_bar], ["Hyplerledger","Hyplerledger", "Fabric*", "Fabric*"], loc="upper left")
plt.show()    