...
# Read csv
hyperledger_path = "TransactionLoad/Create_Assets_16000/Hyperledger_Evaluation.csv"
fabricstar_path = "TransactionLoad/Create_Assets_16000/FabricStar_Evaluation.csv"
